...
urlpatterns = patterns('',
    ...
    url(r'^establecimiento/completar_conexion_internet/', 'registro.views.establecimiento.completar_conexion_internet', name = 'establecimientoCompletarConexionInternet'),
    url(r'^establecimiento/([0-9]+)/registrar', 'registro.views.establecimiento.registrar', name = 'establecimientoRegistrar'),
    url(r'^establecimiento/datos_establecimiento', 'registro.views.establecimiento.datos_establecimiento', name = 'establecimientoDatos'),
    ...
    url(r'^anexo/([0-9]+)/baja', 'registro.views.anexo.baja', name = 'anexoBaja'),
    ...
    url(r'^unidad_extension/([0-9]+)/baja', 'registro.views.unidad_extension.baja', name = 'unidadExtensionBaja'),
