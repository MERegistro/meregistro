...
PRIMERA_COHORTE_CHOICES = [('', '-------')] + [(i, i) for i in range(CohortePostitulo.PRIMER_ANIO, CohortePostitulo.ULTIMO_ANIO)]
ULTIMA_COHORTE_CHOICES = [('', '-------')] + [(i, i) for i in range(CohortePostitulo.PRIMER_ANIO, CohortePostitulo.ULTIMO_ANIO + 5)]
