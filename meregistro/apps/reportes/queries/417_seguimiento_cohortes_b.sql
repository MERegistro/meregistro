...
left join titulos_cohorte_establecimiento_seguimiento ces on ce.id=ces.cohorte_establecimiento_id
...
left join titulos_cohorte_anexo_seguimiento caxs on cax.id=caxs.cohorte_anexo_id
inner join registro_dependencia_funcional as df on df.id=e.dependencia_funcional_id
inner join registro_tipo_gestion tg on tg.id=df.tipo_gestion_id
--
...
left join titulos_cohorte_extension_aulica_seguimiento ceas on cea.id=ceas.cohorte_extension_aulica_id
inner join registro_dependencia_funcional as df on df.id=e.dependencia_funcional_id
inner join registro_tipo_gestion tg on tg.id=df.tipo_gestion_id
--
