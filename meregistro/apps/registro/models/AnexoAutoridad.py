...
class AnexoAutoridad(models.Model):
    anexo = models.ForeignKey(Anexo, editable=False, related_name='autoridades')
    ...
    class Meta:
        app_label = 'registro'
        db_table = 'registro_anexo_autoridades'

    def __unicode__(self):
        return self.cargo.descripcion + ": " + self.apellido + " " + self.nombre

    def __init__(self, *args, **kwargs):
        super(AnexoAutoridad, self).__init__(*args, **kwargs)
