...
from apps.registro.models import Anexo, AutoridadCargo, ExtensionAulicaAutoridad
from apps.seguridad.models import TipoDocumento
from django.core.exceptions import ValidationError
import dates

class ExtensionAulicaAutoridadForm(ModelForm):
    ...
    class Meta:
        model = ExtensionAulicaAutoridad
