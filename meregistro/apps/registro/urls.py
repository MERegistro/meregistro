...
urlpatterns = patterns('',
    ...
    url(r'^establecimiento/edit', 'apps.registro.views.establecimiento.edit', name='establecimientoEditUnico'),
    ...
    url(r'^anexo/edit', 'apps.registro.views.anexo.edit', name='anexoEditUnico'),
