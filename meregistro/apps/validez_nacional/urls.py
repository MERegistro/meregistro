...
urlpatterns=patterns('',
    ...
    url(r'^solicitud/([0-9]+)/eliminar$', 'apps.validez_nacional.views.solicitud.delete', name='validezNacionalSolicitudEliminar'),
    url(r'^solicitud/([0-9]+)/informe$', 'apps.validez_nacional.views.solicitud.informe', name='validezNacionalSolicitudInforme'),
    url(r'^solicitud/([0-9]+)/informe_impresion$', 'apps.validez_nacional.views.solicitud.informe_impresion', name='validezNacionalSolicitudInformeImpresion'),
    ...
    url(r'^validez/([0-9]+)/duplicar$', 'apps.validez_nacional.views.validez.duplicar', name='validezNacionalDuplicar'),
    # AJAX
