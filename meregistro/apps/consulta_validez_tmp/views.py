...
from apps.consulta_validez_tmp.models import UnidadEducativa, Titulo
from apps.consulta_validez_tmp.forms import ConsultaValidezFormFilters
...
def index(request):
    ...
    return my_render(request, 'consulta_validez_tmp/index.html', {
...
def detalle(request, titulo_id):
    ...
    return my_render(request, 'consulta_validez_tmp/detalle.html', {
        'titulo': titulo,
        'ue': ue,
        'dom': dom,
