...
from apps.titulos.forms import TituloNacionalFormFilters, TituloNacionalForm
...
def index(request):
	...
	if request.method == 'GET':
		form_filter = TituloNacionalFormFilters(request.GET)
	else:
		form_filter = TituloNacionalFormFilters()
	...
	return my_render(request, 'titulos/titulo_nacional/index.html', {
