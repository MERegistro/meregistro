...
from apps.titulos.models import CarreraJurisdiccional

HORAS_DURACION_4 = 2600
HORAS_DURACION_5 = 2860

class CarreraJurisdiccionalDuracionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(CarreraJurisdiccionalDuracionForm, self).__init__(*args, **kwargs)
