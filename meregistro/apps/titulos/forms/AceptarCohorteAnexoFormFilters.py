...
class AceptarCohorteAnexoFormFilters(forms.Form):
    ...
    estado = forms.ModelChoiceField(queryset = EstadoCohorteAnexo.objects.all().order_by('nombre'), required = False)
