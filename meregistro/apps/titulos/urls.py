...
urlpatterns=patterns('',
    ...
    url(r'^cohorte_seguimiento/cohorte_(?P<tipo_unidad_educativa>[a-z_]+)/(?P<cohorte_ue_id>[0-9]+)/finalizar_seguimiento$', 'apps.titulos.views.cohorte_seguimiento.finalizar_seguimiento', name='cohorteFinalizarSeguimiento'),
    url(r'^cohorte_seguimiento/cohorte_(?P<tipo_unidad_educativa>[a-z_]+)/(?P<cohorte_ue_id>[0-9]+)/reactivar_seguimiento$', 'apps.titulos.views.cohorte_seguimiento.reactivar_seguimiento', name='cohorteReactivarSeguimiento'),
    #
