...
urlpatterns = patterns('',
    ...
    url(r'^carrera_jurisdiccional/create$', 'apps.titulos.views.titulo_jurisdiccional.create', name = 'tituloJurisdiccionalCreate'),
    url(r'^carrera_jurisdiccional/([0-9]+)/orientaciones$', 'apps.titulos.views.titulo_jurisdiccional.orientaciones_por_titulo', name = 'orientacionesPorTituloJurisdiccional'),
    url(r'^carrera_jurisdiccional/([0-9]+)/editar_orientaciones$', 'apps.titulos.views.titulo_jurisdiccional.editar_orientaciones', name = 'tituloJurisdiccionalOrientacionesEdit'),
    url(r'^carrera_jurisdiccional/editar_orientaciones$', 'apps.titulos.views.titulo_jurisdiccional.editar_orientaciones', { 'titulo_jurisdiccional_id': None }, name = 'tituloJurisdiccionalOrientacionesEdit'),
    url(r'^carrera_jurisdiccional/([0-9]+)/editar_modalidades$', 'apps.titulos.views.titulo_jurisdiccional.editar_modalidades', name = 'tituloJurisdiccionalModalidadesEdit'),
    url(r'^carrera_jurisdiccional/editar_modalidades$', 'apps.titulos.views.titulo_jurisdiccional.editar_modalidades', { 'titulo_jurisdiccional_id': None }, name = 'tituloJurisdiccionalModalidadesEdit'),
    url(r'^carrera_jurisdiccional/([0-9]+)/editar_normativas$', 'apps.titulos.views.titulo_jurisdiccional.editar_normativas', name = 'tituloJurisdiccionalNormativasEdit'),
    url(r'^carrera_jurisdiccional/editar_normativas$', 'apps.titulos.views.titulo_jurisdiccional.editar_normativas', { 'titulo_jurisdiccional_id': None }, name = 'tituloJurisdiccionalNormativasEdit'),
    url(r'^carrera_jurisdiccional/([0-9]+)/editar_cohortes$', 'apps.titulos.views.titulo_jurisdiccional.editar_cohortes', name = 'tituloJurisdiccionalCohortesEdit'),
    url(r'^carrera_jurisdiccional/editar_cohortes$', 'apps.titulos.views.titulo_jurisdiccional.editar_cohortes', { 'titulo_jurisdiccional_id': None }, name = 'tituloJurisdiccionalCohortesEdit'),
    url(r'^carrera_jurisdiccional/([0-9]+)/edit$', 'apps.titulos.views.titulo_jurisdiccional.edit', name = 'tituloJurisdiccionalEdit'),
    url(r'^carrera_jurisdiccional$', 'apps.titulos.views.titulo_jurisdiccional.index', name = 'tituloJurisdiccional'),
    url(r'^carrera_jurisdiccional/([0-9]+)/revisar_jurisdiccion$', 'apps.titulos.views.titulo_jurisdiccional.revisar_jurisdiccion', name = 'tituloJurisdiccionalRevisarJurisdiccion'),
    # Cohorte
