...
urlpatterns=patterns('',
    ...
    url(r'^cohorte_seguimiento/cohorte_(?P<tipo_unidad_educativa>[a-z_]+)/(?P<cohorte_ue_id>[0-9]+)/finalizar$', 'apps.titulos.views.cohorte_seguimiento.finalizar_seguimiento', name='cohorteFinalizarSeguimiento'),
    #
