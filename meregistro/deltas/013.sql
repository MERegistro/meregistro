...
CREATE UNIQUE INDEX registro_establecimiento_cue_idx
  ON registro_establecimiento
  USING btree
  (cue);

INSERT INTO deltas_sql (numero, app, comentario) VALUES ('013', 'Registro', 'Cambio en el CUE de establecimiento - Ticket #111');
